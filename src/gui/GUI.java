...
public class GUI extends UDPClient {
    ...
    public void createAndShowGUI() {
        ...
        panel2 = new JPanel();
        panel2.setSize(new Dimension(200, 200));
        panel2.setBackground(Color.DARK_GRAY);

        panel3 = new JPanel();
        panel3.setSize(new Dimension(200, 200));
        panel3.setBackground(Color.DARK_GRAY);

        panel4 = new JPanel();
        panel4.setSize(new Dimension(200, 200));
        panel4.setBackground(Color.DARK_GRAY);

        errorPanel = new JPanel();
        errorPanel.setSize(new Dimension(500, 1000));
        ...
        elevator1Position.setPreferredSize(new Dimension(180, 50));
        ...
        elevator2Position.setPreferredSize(new Dimension(180, 50));
        ...
        elevator3Position.setPreferredSize(new Dimension(180, 50));
        ...
        elevator4Position.setPreferredSize(new Dimension(180, 50));
        ...
        errorLog.setPreferredSize(new Dimension(350, 900));
